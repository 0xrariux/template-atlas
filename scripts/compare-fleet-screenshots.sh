...
reference_dir="${1:-$repo_root/ai/reference/fleet/golden}"
candidate_dir="${2:-$repo_root/ai/comparison/fleet/candidate}"
output_dir="${3:-$repo_root/ai/comparison/fleet/diff}"
