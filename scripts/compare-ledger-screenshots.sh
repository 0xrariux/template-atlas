...
reference_dir="${1:-$repo_root/ai/reference/ledger/golden}"
candidate_dir="${2:-$repo_root/ai/comparison/ledger/candidate}"
output_dir="${3:-$repo_root/ai/comparison/ledger/diff}"
